...
public interface Function11<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, R> {
     ...
     * @param <V>       The result of this <code>Function11</code> that is applied first
     * @return          The composite function <code>Function11</code>
     */
    default <V> Function11<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, V> andThen(Function1<R, V> after) {
