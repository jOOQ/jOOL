...
public interface Function10<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, R> {
     ...
     * @param <V>       The result of this <code>Function10</code> that is applied first
     * @return          The composite function <code>Function10</code>
     */
    default <V> Function10<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, V> andThen(Function1<R, V> after) {
