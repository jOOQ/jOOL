...
public class Tuple12<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12> implements Tuple, Comparable<Tuple12<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12>>, Serializable, Cloneable {
     ...
     */
    public Comparator<Tuple12<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12>> asc1() {
        return Comparator.comparing((Tuple12<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12> t) -> t.v1, (Comparator) Comparator.naturalOrder());
    }

    /**
     * A comparator to order by element 2 ascendingly.
     */
    public Comparator<Tuple12<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12>> asc2() {
        return Comparator.comparing((Tuple12<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12> t) -> t.v2, (Comparator) Comparator.naturalOrder());
    }

    /**
     * A comparator to order by element 3 ascendingly.
     */
    public Comparator<Tuple12<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12>> asc3() {
        return Comparator.comparing((Tuple12<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12> t) -> t.v3, (Comparator) Comparator.naturalOrder());
    }

    /**
     * A comparator to order by element 4 ascendingly.
     */
    public Comparator<Tuple12<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12>> asc4() {
        return Comparator.comparing((Tuple12<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12> t) -> t.v4, (Comparator) Comparator.naturalOrder());
    }

    /**
     * A comparator to order by element 5 ascendingly.
     */
    public Comparator<Tuple12<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12>> asc5() {
        return Comparator.comparing((Tuple12<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12> t) -> t.v5, (Comparator) Comparator.naturalOrder());
    }

    /**
     * A comparator to order by element 6 ascendingly.
     */
    public Comparator<Tuple12<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12>> asc6() {
        return Comparator.comparing((Tuple12<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12> t) -> t.v6, (Comparator) Comparator.naturalOrder());
    }

    /**
     * A comparator to order by element 7 ascendingly.
     */
    public Comparator<Tuple12<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12>> asc7() {
        return Comparator.comparing((Tuple12<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12> t) -> t.v7, (Comparator) Comparator.naturalOrder());
    }

    /**
     * A comparator to order by element 8 ascendingly.
     */
    public Comparator<Tuple12<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12>> asc8() {
        return Comparator.comparing((Tuple12<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12> t) -> t.v8, (Comparator) Comparator.naturalOrder());
    }

    /**
     * A comparator to order by element 9 ascendingly.
     */
    public Comparator<Tuple12<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12>> asc9() {
        return Comparator.comparing((Tuple12<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12> t) -> t.v9, (Comparator) Comparator.naturalOrder());
    }

    /**
     * A comparator to order by element 10 ascendingly.
     */
    public Comparator<Tuple12<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12>> asc10() {
        return Comparator.comparing((Tuple12<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12> t) -> t.v10, (Comparator) Comparator.naturalOrder());
    }

    /**
     * A comparator to order by element 11 ascendingly.
     */
    public Comparator<Tuple12<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12>> asc11() {
        return Comparator.comparing((Tuple12<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12> t) -> t.v11, (Comparator) Comparator.naturalOrder());
    }

    /**
     * A comparator to order by element 12 ascendingly.
     */
    public Comparator<Tuple12<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12>> asc12() {
        return Comparator.comparing((Tuple12<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12> t) -> t.v12, (Comparator) Comparator.naturalOrder());
    }

    /**
     * A comparator to order by element 1 descendingly.
     */
    public Comparator<Tuple12<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12>> desc1() {
        return Comparator.comparing((Tuple12<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12> t) -> t.v1, (Comparator) Comparator.reverseOrder());
    }

    /**
     * A comparator to order by element 2 descendingly.
     */
    public Comparator<Tuple12<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12>> desc2() {
        return Comparator.comparing((Tuple12<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12> t) -> t.v2, (Comparator) Comparator.reverseOrder());
    }

    /**
     * A comparator to order by element 3 descendingly.
     */
    public Comparator<Tuple12<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12>> desc3() {
        return Comparator.comparing((Tuple12<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12> t) -> t.v3, (Comparator) Comparator.reverseOrder());
    }

    /**
     * A comparator to order by element 4 descendingly.
     */
    public Comparator<Tuple12<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12>> desc4() {
        return Comparator.comparing((Tuple12<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12> t) -> t.v4, (Comparator) Comparator.reverseOrder());
    }

    /**
     * A comparator to order by element 5 descendingly.
     */
    public Comparator<Tuple12<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12>> desc5() {
        return Comparator.comparing((Tuple12<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12> t) -> t.v5, (Comparator) Comparator.reverseOrder());
    }

    /**
     * A comparator to order by element 6 descendingly.
     */
    public Comparator<Tuple12<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12>> desc6() {
        return Comparator.comparing((Tuple12<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12> t) -> t.v6, (Comparator) Comparator.reverseOrder());
    }

    /**
     * A comparator to order by element 7 descendingly.
     */
    public Comparator<Tuple12<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12>> desc7() {
        return Comparator.comparing((Tuple12<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12> t) -> t.v7, (Comparator) Comparator.reverseOrder());
    }

    /**
     * A comparator to order by element 8 descendingly.
     */
    public Comparator<Tuple12<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12>> desc8() {
        return Comparator.comparing((Tuple12<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12> t) -> t.v8, (Comparator) Comparator.reverseOrder());
    }

    /**
     * A comparator to order by element 9 descendingly.
     */
    public Comparator<Tuple12<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12>> desc9() {
        return Comparator.comparing((Tuple12<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12> t) -> t.v9, (Comparator) Comparator.reverseOrder());
    }

    /**
     * A comparator to order by element 10 descendingly.
     */
    public Comparator<Tuple12<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12>> desc10() {
        return Comparator.comparing((Tuple12<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12> t) -> t.v10, (Comparator) Comparator.reverseOrder());
    }

    /**
     * A comparator to order by element 11 descendingly.
     */
    public Comparator<Tuple12<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12>> desc11() {
        return Comparator.comparing((Tuple12<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12> t) -> t.v11, (Comparator) Comparator.reverseOrder());
    }

    /**
     * A comparator to order by element 12 descendingly.
     */
    public Comparator<Tuple12<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12>> desc12() {
        return Comparator.comparing((Tuple12<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12> t) -> t.v12, (Comparator) Comparator.reverseOrder());
    }
