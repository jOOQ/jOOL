...
public class Tuple10<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10> implements Tuple, Comparable<Tuple10<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10>>, Serializable, Cloneable {
     ...
     */
    public Comparator<Tuple10<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10>> asc1() {
        return Comparator.comparing((Tuple10<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10> t) -> t.v1, (Comparator) Comparator.naturalOrder());
    }

    /**
     * A comparator to order by element 2 ascendingly.
     */
    public Comparator<Tuple10<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10>> asc2() {
        return Comparator.comparing((Tuple10<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10> t) -> t.v2, (Comparator) Comparator.naturalOrder());
    }

    /**
     * A comparator to order by element 3 ascendingly.
     */
    public Comparator<Tuple10<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10>> asc3() {
        return Comparator.comparing((Tuple10<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10> t) -> t.v3, (Comparator) Comparator.naturalOrder());
    }

    /**
     * A comparator to order by element 4 ascendingly.
     */
    public Comparator<Tuple10<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10>> asc4() {
        return Comparator.comparing((Tuple10<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10> t) -> t.v4, (Comparator) Comparator.naturalOrder());
    }

    /**
     * A comparator to order by element 5 ascendingly.
     */
    public Comparator<Tuple10<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10>> asc5() {
        return Comparator.comparing((Tuple10<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10> t) -> t.v5, (Comparator) Comparator.naturalOrder());
    }

    /**
     * A comparator to order by element 6 ascendingly.
     */
    public Comparator<Tuple10<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10>> asc6() {
        return Comparator.comparing((Tuple10<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10> t) -> t.v6, (Comparator) Comparator.naturalOrder());
    }

    /**
     * A comparator to order by element 7 ascendingly.
     */
    public Comparator<Tuple10<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10>> asc7() {
        return Comparator.comparing((Tuple10<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10> t) -> t.v7, (Comparator) Comparator.naturalOrder());
    }

    /**
     * A comparator to order by element 8 ascendingly.
     */
    public Comparator<Tuple10<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10>> asc8() {
        return Comparator.comparing((Tuple10<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10> t) -> t.v8, (Comparator) Comparator.naturalOrder());
    }

    /**
     * A comparator to order by element 9 ascendingly.
     */
    public Comparator<Tuple10<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10>> asc9() {
        return Comparator.comparing((Tuple10<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10> t) -> t.v9, (Comparator) Comparator.naturalOrder());
    }

    /**
     * A comparator to order by element 10 ascendingly.
     */
    public Comparator<Tuple10<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10>> asc10() {
        return Comparator.comparing((Tuple10<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10> t) -> t.v10, (Comparator) Comparator.naturalOrder());
    }

    /**
     * A comparator to order by element 1 descendingly.
     */
    public Comparator<Tuple10<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10>> desc1() {
        return Comparator.comparing((Tuple10<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10> t) -> t.v1, (Comparator) Comparator.reverseOrder());
    }

    /**
     * A comparator to order by element 2 descendingly.
     */
    public Comparator<Tuple10<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10>> desc2() {
        return Comparator.comparing((Tuple10<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10> t) -> t.v2, (Comparator) Comparator.reverseOrder());
    }

    /**
     * A comparator to order by element 3 descendingly.
     */
    public Comparator<Tuple10<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10>> desc3() {
        return Comparator.comparing((Tuple10<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10> t) -> t.v3, (Comparator) Comparator.reverseOrder());
    }

    /**
     * A comparator to order by element 4 descendingly.
     */
    public Comparator<Tuple10<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10>> desc4() {
        return Comparator.comparing((Tuple10<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10> t) -> t.v4, (Comparator) Comparator.reverseOrder());
    }

    /**
     * A comparator to order by element 5 descendingly.
     */
    public Comparator<Tuple10<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10>> desc5() {
        return Comparator.comparing((Tuple10<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10> t) -> t.v5, (Comparator) Comparator.reverseOrder());
    }

    /**
     * A comparator to order by element 6 descendingly.
     */
    public Comparator<Tuple10<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10>> desc6() {
        return Comparator.comparing((Tuple10<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10> t) -> t.v6, (Comparator) Comparator.reverseOrder());
    }

    /**
     * A comparator to order by element 7 descendingly.
     */
    public Comparator<Tuple10<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10>> desc7() {
        return Comparator.comparing((Tuple10<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10> t) -> t.v7, (Comparator) Comparator.reverseOrder());
    }

    /**
     * A comparator to order by element 8 descendingly.
     */
    public Comparator<Tuple10<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10>> desc8() {
        return Comparator.comparing((Tuple10<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10> t) -> t.v8, (Comparator) Comparator.reverseOrder());
    }

    /**
     * A comparator to order by element 9 descendingly.
     */
    public Comparator<Tuple10<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10>> desc9() {
        return Comparator.comparing((Tuple10<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10> t) -> t.v9, (Comparator) Comparator.reverseOrder());
    }

    /**
     * A comparator to order by element 10 descendingly.
     */
    public Comparator<Tuple10<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10>> desc10() {
        return Comparator.comparing((Tuple10<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10> t) -> t.v10, (Comparator) Comparator.reverseOrder());
    }
