...
public class Tuple5<T1, T2, T3, T4, T5> implements Tuple, Comparable<Tuple5<T1, T2, T3, T4, T5>>, Serializable, Cloneable {
     ...
     */
    public Comparator<Tuple5<T1, T2, T3, T4, T5>> asc1() {
        return Comparator.comparing((Tuple5<T1, T2, T3, T4, T5> t) -> t.v1, (Comparator) Comparator.naturalOrder());
    }

    /**
     * A comparator to order by element 2 ascendingly.
     */
    public Comparator<Tuple5<T1, T2, T3, T4, T5>> asc2() {
        return Comparator.comparing((Tuple5<T1, T2, T3, T4, T5> t) -> t.v2, (Comparator) Comparator.naturalOrder());
    }

    /**
     * A comparator to order by element 3 ascendingly.
     */
    public Comparator<Tuple5<T1, T2, T3, T4, T5>> asc3() {
        return Comparator.comparing((Tuple5<T1, T2, T3, T4, T5> t) -> t.v3, (Comparator) Comparator.naturalOrder());
    }

    /**
     * A comparator to order by element 4 ascendingly.
     */
    public Comparator<Tuple5<T1, T2, T3, T4, T5>> asc4() {
        return Comparator.comparing((Tuple5<T1, T2, T3, T4, T5> t) -> t.v4, (Comparator) Comparator.naturalOrder());
    }

    /**
     * A comparator to order by element 5 ascendingly.
     */
    public Comparator<Tuple5<T1, T2, T3, T4, T5>> asc5() {
        return Comparator.comparing((Tuple5<T1, T2, T3, T4, T5> t) -> t.v5, (Comparator) Comparator.naturalOrder());
    }

    /**
     * A comparator to order by element 1 descendingly.
     */
    public Comparator<Tuple5<T1, T2, T3, T4, T5>> desc1() {
        return Comparator.comparing((Tuple5<T1, T2, T3, T4, T5> t) -> t.v1, (Comparator) Comparator.reverseOrder());
    }

    /**
     * A comparator to order by element 2 descendingly.
     */
    public Comparator<Tuple5<T1, T2, T3, T4, T5>> desc2() {
        return Comparator.comparing((Tuple5<T1, T2, T3, T4, T5> t) -> t.v2, (Comparator) Comparator.reverseOrder());
    }

    /**
     * A comparator to order by element 3 descendingly.
     */
    public Comparator<Tuple5<T1, T2, T3, T4, T5>> desc3() {
        return Comparator.comparing((Tuple5<T1, T2, T3, T4, T5> t) -> t.v3, (Comparator) Comparator.reverseOrder());
    }

    /**
     * A comparator to order by element 4 descendingly.
     */
    public Comparator<Tuple5<T1, T2, T3, T4, T5>> desc4() {
        return Comparator.comparing((Tuple5<T1, T2, T3, T4, T5> t) -> t.v4, (Comparator) Comparator.reverseOrder());
    }

    /**
     * A comparator to order by element 5 descendingly.
     */
    public Comparator<Tuple5<T1, T2, T3, T4, T5>> desc5() {
        return Comparator.comparing((Tuple5<T1, T2, T3, T4, T5> t) -> t.v5, (Comparator) Comparator.reverseOrder());
    }
