...
public interface Consumer5<T1, T2, T3, T4, T5> {
     ...
     */
    default Consumer4<T2, T3, T4, T5> curry(T1 v1) {
     ...
     * Let this consumer partially accept the arguments.
     */
    default Consumer3<T3, T4, T5> curry(T1 v1, T2 v2) {
     ...
     * Let this consumer partially accept the arguments.
     */
    default Consumer2<T4, T5> curry(T1 v1, T2 v2, T3 v3) {
     ...
     * Let this consumer partially accept the arguments.
     */
    default Consumer1<T5> curry(T1 v1, T2 v2, T3 v3, T4 v4) {
     ...
     * Let this consumer partially accept the arguments.
     */
    default Consumer0 curry(T1 v1, T2 v2, T3 v3, T4 v4, T5 v5) {
     ...
     * Let this consumer partially accept the arguments.
     */
    default Consumer4<T2, T3, T4, T5> curry(Tuple1<? extends T1> args) {
     ...
     * Let this consumer partially accept the arguments.
     */
    default Consumer3<T3, T4, T5> curry(Tuple2<? extends T1, ? extends T2> args) {
     ...
     * Let this consumer partially accept the arguments.
     */
    default Consumer2<T4, T5> curry(Tuple3<? extends T1, ? extends T2, ? extends T3> args) {
     ...
     * Let this consumer partially accept the arguments.
     */
    default Consumer1<T5> curry(Tuple4<? extends T1, ? extends T2, ? extends T3, ? extends T4> args) {
     ...
     * Let this consumer partially accept the arguments.
     */
    default Consumer0 curry(Tuple5<? extends T1, ? extends T2, ? extends T3, ? extends T4, ? extends T5> args) {
